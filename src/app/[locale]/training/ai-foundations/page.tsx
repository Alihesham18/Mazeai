...
const page: StandalonePageConfig = {
  path: "training/ai-foundations",
  titleKey: "pages.placeholder.title",
  descriptionKey: "pages.placeholder.description",
  sections: ["Program overview", "Curriculum", "Schedule", "Application"]
};

export const generateMetadata = createPageMetadata(page);

export default function AiFoundationsPage({ params }: { params: { locale: Locale } }) {
